...
class InceptionResNetV2(nn.Module):
    ...
    def __init__(self, num_classes =1000):
        ...
        print('Inception_Resnet_v2 with no grad...')
    ...
    def get_hidden_features(self, input):
        hid_list = []
        x = self.conv2d_1a(input)
        x = self.conv2d_2a(x)
        x = self.conv2d_2b(x)  ##
    ...
    def forward(self, input):
        ...
        # x = self.logits(x)
        hid_list = self.get_hidden_features(input)
        return hid_list
...
if __name__ == '__main__':
    ...
    resnet = inceptionresnetv2(num_classes=345, pretrained='imagenet')
    clf = nn.Linear(1536, 345)
    print(resnet)
    print("fuck")
    print(clf)
    # print('success')
